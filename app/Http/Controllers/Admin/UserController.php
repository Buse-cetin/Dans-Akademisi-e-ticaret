...
{
    public function __construct() //Bütün users'larımı burdn besleyeceğim
    {
     ...
     * @return View
     */
    public function index(): View //kullanıcıyı çekip geri gönderdiğim fonk.
    {
        $users = User::all();
     ...
     * @return JsonResponse
     */
    public function destroy(User $user): JsonResponse //kullanıcı silme işlemini yapan fonk.
    {
        $user->delete();
